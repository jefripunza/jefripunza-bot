...
class WhatsApp {
    ...
    default_message = {
        ...
        success: '*𝗦𝗨𝗖𝗖𝗘𝗦𝗦...*',
        error: {
            sticker: ' *𝗠𝗔𝗔𝗙 𝗧𝗘𝗥𝗝𝗔𝗗𝗜 𝗞𝗘𝗦𝗔𝗟𝗔𝗛 𝗦𝗔𝗔𝗧 𝗖𝗢𝗡𝗩𝗘𝗥𝗧 𝗧𝗢 𝗦𝗧𝗜𝗖𝗞𝗘𝗥*',
            link_not_valid: '*𝗠𝗔𝗔𝗙 𝗟𝗜𝗡𝗞 𝗧𝗜𝗗𝗔𝗞 𝗩𝗔𝗟𝗜𝗗!!*'
        },
        only: {
            group: '*𝗠𝗔𝗔𝗙 𝗙𝗜𝗧𝗨𝗥 𝗜𝗡𝗜 𝗛𝗔𝗡𝗬𝗔 𝗕𝗜𝗦𝗔 𝗗𝗜 𝗚𝗨𝗡𝗔𝗞𝗔𝗡 𝗗𝗜 𝗗𝗔𝗟𝗔𝗠 𝗚𝗥𝗢𝗨𝗣!*',
            banned: '*𝗠𝗔𝗔𝗙 𝗡𝗢𝗠𝗢𝗥 𝗔𝗡𝗗𝗔 𝗗𝗜 𝗕𝗔𝗡 𝗦𝗜𝗟𝗔𝗛𝗞𝗔𝗡 𝗛𝗨𝗕𝗨𝗡𝗚𝗜 𝗔𝗗𝗠𝗜𝗡 𝗨𝗡𝗧𝗨𝗞 𝗨𝗡𝗕𝗔𝗡!*',
            owner_cmd_group: '*𝗠𝗔𝗔𝗙, 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 𝗜𝗡𝗜 𝗞𝗛𝗨𝗦𝗨𝗦 𝗨𝗡𝗧𝗨𝗞 𝗔𝗗𝗠𝗜𝗡 𝗚𝗥𝗢𝗨𝗣!*',
            owner_feature: '*𝗠𝗔𝗔𝗙, 𝗙𝗜𝗧𝗨𝗥 𝗜𝗡𝗜 𝗞𝗛𝗨𝗦𝗨𝗦 𝗨𝗡𝗧𝗨𝗞 𝗔𝗗𝗠𝗜𝗡* ',
            owner_feature_group: '*𝗠𝗔𝗔𝗙, 𝗙𝗜𝗧𝗨𝗥 𝗜𝗡𝗜 𝗞𝗛𝗨𝗦𝗨𝗦 𝗨𝗡𝗧𝗨𝗞 𝗔𝗗𝗠𝗜𝗡 𝗚𝗥𝗢𝗨𝗣* ',
            join: '*𝗙𝗜𝗧𝗨𝗥 𝗧𝗘𝗥𝗞𝗨𝗡𝗖𝗜!!!\n𝗞𝗛𝗨𝗦𝗨𝗦 𝗣𝗘𝗡𝗚𝗚𝗨𝗡𝗔 𝗬𝗔𝗡𝗚 𝗦𝗨𝗗𝗔𝗛 𝗝𝗢𝗜𝗡!!!*',
            if_bot_admin: '*𝗠𝗮𝗮𝗳, 𝗕𝗼𝘁 𝗕𝗲𝗹𝘂𝗺 𝗝𝗮𝗱𝗶 𝗔𝗱𝗺𝗶𝗻 𝗦𝗶𝗹𝗮𝗵𝗸𝗮𝗻 𝗝𝗮𝗱𝗶𝗸𝗮𝗻 𝗕𝗼𝘁 𝗔𝗱𝗺𝗶𝗻 𝗧𝗲𝗿𝗹𝗲𝗯𝗶𝗵 𝗗𝗮𝗵𝘂𝗹𝘂...*',
        }
    }
    // =============================== FUNCTION ===============================
    isArray(value) {
    ...
    getRandomFile = (ext) => {
        return this.generateRandomString() + "." + ext;
    }
            ...
            const fungsi = {
                ...
                ping: async () => {
                    ...
                    tutorial_standard.push({
                        ...
                        rowId: this.generateRandomString(),
                    });
                },
                // ===============================================================================================
                tts: async () => {
                        ...
                        if ([
                            ...
                            if (isGroup) {
                                if (isMedia || isQuotedImage || isQuotedVideo) {
                                    const default_message = this.default_message;
                                    try {
                                        ...
                                        await ffmpeg(media)
                                            ...
                                            .on('error', async (err) => {
                                                await fungsi.reply(default_message.error.sticker, () => {
